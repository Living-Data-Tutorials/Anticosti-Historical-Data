...
#### The Living Data Tutorials (LDTs) were developped by graduate students in ecology and evolution during the spring of 2022. Our aims were to provide free and open-access teaching material in the form of online tutorials for undergraduate students in ecology and evolution. All the tutorials make use of a freely accessible canadian dataset to address specific topics in ecology and evolution. The following tutorial was built with the open-source R language using the [leanr package](https://rstudio.github.io/learnr/). You can find the project folders and files in this [GitHub repository](https://github.com/Living-Data-Tutorials/Anticosti-Historical-Data).

The present tutorial was developed by Victoria Marie Glynn who is a PhD student at McGill University in Montreal, and Maxime Fraser Franco who is a PhD student at UQAM university in Montreal. Please feel free to contact us if you have any question.

Victoria Marie Glynn - email
...
# Change "Pine" to "Pine spp."
# Change "Aspen" to "Aspen spp."
tree$Species <- gsub("Larch", "American larch", tree$Species)
tree$Species <- gsub("Pine", "Pine spp.", tree$Species)
tree$Species <- gsub("Aspen", "Aspen spp.", tree$Species)
